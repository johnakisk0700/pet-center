...
const CatFoodScreen = () => {
    return (
        <div>
            ...
            <Row className='justify-content-center'>Και μερικές μαλακίες για τις γατοτροφές</Row>
            <Row className='justify-content-center my-4'>
                <MenuRect title='Ξηρά Τροφή' img='/menu-photos/cat/cat-food.png' url='/gata/trofes/kshra/proionta' />
